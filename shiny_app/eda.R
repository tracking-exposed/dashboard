...
saveRDS(lang_freq, "shiny/language_frequencies.rds", compress = FALSE)
...
saveRDS(frequent_words, "shiny/frequent_words.rds", compress = FALSE)
...
saveRDS(frequency, "shiny/frequency_table.rds", compress = FALSE)
...
saveRDS(subset, "shiny/subset_for_text.rds", compress = FALSE)
